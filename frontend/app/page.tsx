  ...
  return (
    <div className="relative w-full">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              ...
              <a className="text-sm font-medium hover:text-accent dark:hover:text-accent transition-colors" href="/site-photos">Our Projects</a>
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden absolute top-full left-0 right-0 bg-background-light dark:bg-background-dark border-t border-neutral/20 shadow-lg">
              <nav className="flex flex-col gap-4">
                ...
                <a onClick={() => setMobileMenuOpen(false)} className="text-base font-medium hover:text-accent dark:hover:text-accent transition-colors py-2" href="/#about">About</a>
                ...
                <a onClick={() => setMobileMenuOpen(false)} className="text-base font-medium hover:text-accent dark:hover:text-accent transition-colors py-2" href="/site-photos">Our Projects</a>
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen px-8 py-16 sm:px-12 md:px-16 lg:px-24 pt-32">
          <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex flex-col items-start gap-8 text-left">
              <div className="flex flex-col gap-4 animate-on-scroll animate-fade-in-left">
              ...
              {/* Stats Section */}
              <div className="flex flex-wrap gap-x-8 gap-y-4 pt-4 animate-on-scroll animate-fade-in-up animation-delay-200">
              ...
              {/* Buttons Section */}
              <div className="flex flex-wrap gap-4 pt-6 animate-on-scroll animate-fade-in-up animation-delay-400">
            ...
            <div className="relative hidden lg:flex items-center justify-center h-[500px]">
              <div className="absolute w-[60%] h-[70%] top-0 right-0 transform rotate-6 transition-transform group-hover:rotate-3 animate-on-scroll animate-fade-in-right animation-delay-300">
              ...
              <div className="absolute w-[70%] h-[80%] bottom-0 left-0 transform -rotate-3 transition-transform group-hover:-rotate-1 animate-on-scroll animate-fade-in-right animation-delay-500">
      ...
      <section id="services" className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-on-scroll animate-fade-in-up">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="flex flex-col gap-4 rounded border border-neutral/50 bg-white/30 dark:bg-primary/20 dark:border-neutral/20 p-6 text-center shadow-sm hover:shadow-lg transition-all hover:scale-105 animate-on-scroll animate-scale-in animation-delay-100">
            ...
            <div className="flex flex-col gap-4 rounded border border-neutral/50 bg-white/30 dark:bg-primary/20 dark:border-neutral/20 p-6 text-center shadow-sm hover:shadow-lg transition-all hover:scale-105 animate-on-scroll animate-scale-in animation-delay-200">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-accent/20 text-accent">
            ...
            <div className="flex flex-col gap-4 rounded border border-neutral/50 bg-white/30 dark:bg-primary/20 dark:border-neutral/20 p-6 text-center shadow-sm hover:shadow-lg transition-all hover:scale-105 animate-on-scroll animate-scale-in animation-delay-300">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-accent/20 text-accent">
            ...
            <div className="flex flex-col gap-4 rounded border border-neutral/50 bg-white/30 dark:bg-primary/20 dark:border-neutral/20 p-6 text-center shadow-sm hover:shadow-lg transition-all hover:scale-105 animate-on-scroll animate-scale-in animation-delay-400">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-accent/20 text-accent">
      ...
      <section className="bg-neutral/30 dark:bg-primary/10 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="group relative overflow-hidden rounded-xl shadow-lg h-[450px] animate-on-scroll animate-fade-in-up animation-delay-100 hover:shadow-2xl transition-all duration-500">
              <Image
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg lg:col-span-2 h-[450px] animate-on-scroll animate-fade-in-up animation-delay-200 hover:shadow-2xl transition-all duration-500">
              <Image
                className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg lg:col-span-2 h-[450px] animate-on-scroll animate-fade-in-up animation-delay-300 hover:shadow-2xl transition-all duration-500">
              <Image
                className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg h-[450px] animate-on-scroll animate-fade-in-up animation-delay-400 hover:shadow-2xl transition-all duration-500">
              <Image
                className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-12 md:grid-cols-4">
            <div className="text-center animate-on-scroll animate-fade-in-up animation-delay-100">
            ...
            <div className="text-center animate-on-scroll animate-fade-in-up animation-delay-200">
              <div className="relative mb-4">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-accent text-grey shadow-lg">
            ...
            <div className="text-center animate-on-scroll animate-fade-in-up animation-delay-300">
              <div className="relative mb-4">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-accent text-grey shadow-lg">
            ...
            <div className="text-center animate-on-scroll animate-fade-in-up animation-delay-400">
              <div className="relative mb-4">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-accent text-grey shadow-lg">
      ...
      <section id="contact" className="bg-gradient-to-b from-white to-[#fcfbf8] dark:from-gray-900 dark:to-[#221d10] py-16 lg:py-24 border-b-2 border-accent/20">
        <div className="px-4 sm:px-6 lg:px-10 xl:px-40 max-w-[1200px] mx-auto">
          <div className="text-center mb-8 lg:mb-10 animate-on-scroll animate-fade-in-up">
      ...
      <section className="w-full bg-background-light dark:bg-background-dark py-16 sm:py-20 lg:py-24 border-t border-neutral/20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 lg:grid-cols-3 sm:gap-x-8 lg:gap-x-12">
            <div className="flex flex-col items-center text-center animate-on-scroll animate-scale-in animation-delay-100">
            ...
            <div className="flex flex-col items-center text-center animate-on-scroll animate-scale-in animation-delay-200">
            ...
            <div className="flex flex-col items-center text-center animate-on-scroll animate-scale-in animation-delay-300">
            ...
            <div className="flex flex-col items-center text-center sm:col-start-1 lg:col-start-auto lg:col-span-1 lg:col-start-2 animate-on-scroll animate-scale-in animation-delay-400">
            ...
            <div className="flex flex-col items-center text-center lg:col-span-1 animate-on-scroll animate-scale-in animation-delay-500">
      ...
      <section className="bg-white dark:bg-gray-900 py-16 lg:py-24">
        <div className="px-4 sm:px-6 lg:px-10 xl:px-40 max-w-[1200px] mx-auto">
          <div className="text-center mb-12 animate-on-scroll animate-fade-in-up">
          ...
          <div className="w-full h-80 lg:h-96 rounded-xl overflow-hidden shadow-xl animate-on-scroll animate-scale-in animation-delay-200">
            <iframe 
      ...
      <section className="relative bg-gradient-to-br from-primary via-accent to-primary py-20 sm:py-24 lg:py-28 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl animate-on-scroll animate-fade-in-up">
      ...
      <section className="bg-background-light dark:bg-background-dark py-16 sm:py-20 lg:py-24 border-t border-neutral/20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center items-center gap-6 sm:gap-8 animate-on-scroll animate-scale-in animation-delay-200">
            {/* Facebook */}
