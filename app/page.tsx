          ...
          {mobileMenuOpen && (
            <div className="lg:hidden absolute top-full left-0 right-0 bg-background-light dark:bg-background-dark border-t border-neutral/20 shadow-lg">
              <nav className="flex flex-col px-4 py-6 space-y-4">
                ...
                <a onClick={() => setMobileMenuOpen(false)} href="#contact" className="flex items-center justify-center gap-2 rounded-lg h-12 px-6 bg-[#25D366] text-white text-base font-bold shadow-sm hover:brightness-110 transition-all mt-4">
